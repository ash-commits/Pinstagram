    ...
    <div class="container">
		<div class="profile">
			...
			<div class="profile-user-settings">
            	<h1 class="profile-user-name">{{ profileUser.title }}</h1><br>
				<button class="btn profile-edit-btn popUps" @click="showModal = true" >Edit Profile</button>
                <transition name = "fade" appear>
                    <div class="modal-overlay" v-if="showModal"></div>
                  </transition>
                  <transition name = "slide" appear>
                   <div class="mod" v-if="showModal"> <!-- <div clas="modal" v-if="showModal"> -->
...
You can only change your name twice within 14 days.</p>
			...
			<div class="profile-stats">
				<ul>
					...
					<li @mousedown="goToListOfFollowers()"><span class="profile-stat-count">188</span> followers</li>
					<li @mousedown="goToListOfFollowing()"><span class="profile-stat-count">96</span> following</li>
				</ul>
			</div>
